...
export class CreateMovieDto {
  @ApiProperty({ example: 'A fascinating movie', description: 'Descrição do enredo do filme' })
  plot: string;
...
export class UpdateMovieDto {
  ...
  @ApiProperty({ example: ['John Doe', 'Jane Smith'], description: 'Elenco do filme' })
  cast?: string[];
  ...
  @ApiProperty({ example: ['John Doe', 'Jane Smith'], description: 'Diretores do filme' })
  directors?: string[];
