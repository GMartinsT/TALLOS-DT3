...
describe('MoviesController', () => {
    ...
    describe('findAllMovies', () => {
        it('deve retornar uma lista de filmes', async () => {
            const result = await moviesController.findAllMovies();
        ...
        it('deve lançar uma exeção', async () => {
            ...
            await expect(moviesController.findAllMovies()).rejects.toThrowError('!ERRO!');
        });

    });

    describe('findMovieById', () => {
        it('deve retornar os dados de um filme', async () => {
            const id = '123id';
            const result = await moviesController.findMovieById(id);
            expect(result).toEqual(Movie);
        ...
        it('deve lançar uma exeção', async () => {
            ...
            await expect(moviesController.findMovieById(id)).rejects.toThrowError('!ERRO!');
        });
    });
    ...
    describe('createMovie', () => {
        it('deve criar um novo filme', async () => {
            ...
            const result = await moviesController.createMovie(body);
            expect(result).toEqual(Movie);
        ...
        it('deve lançar uma exeção', async () => {
            ...
            await expect(moviesController.createMovie(body)).rejects.toThrowError('!ERRO!');
        });
    });
    ...
    describe('updateMovie', () => {
        ...
        it('deve lançar uma exeção', async () => {
            ...
            await expect(moviesController.updateMovie(id, body)).rejects.toThrowError('!ERRO!');
        });
    });
    ...
    describe('remove', () => {
        ...
        it('deve lançar uma exeção', async () => {
            ...
            await expect(moviesController.deleteMovie(id)).rejects.toThrowError('!ERRO!');
        });
    });
});
