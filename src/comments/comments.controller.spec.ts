...
describe('CommentController', () => {
  ...
  describe('findCommentById', () => {
    it('deve retornar os dados de um comentário', async () => {
      const id = '123id';
      const result = await commentController.findCommentById(id);
      expect(result).toEqual(Comment);
    ...
    it('deve lançar uma exeção', async () => {
      ...
      await expect(commentController.findCommentById(id)).rejects.toThrowError(
        '!ERRO!',
      );
    });
  });
  ...
  describe('create', () => {
    ...
    it('deve lançar uma exeção', async () => {
      ...
      await expect(commentController.create(body)).rejects.toThrowError(
        '!ERRO!',
      );
    });
  });
  ...
  describe('update', () => {
    ...
    it('deve lançar uma exeção', async () => {
      ...
      await expect(commentController.update(id, body)).rejects.toThrowError(
        '!ERRO!',
      );
    });
  });
