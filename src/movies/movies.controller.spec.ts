...
describe('MoviesController', () => {
  ...
  describe('findAllMovies', () => {
    ...
    it('deve lançar uma exeção', async () => {
      ...
      await expect(moviesController.findAllMovies()).rejects.toThrowError(
        '!ERRO!',
      );
    });
  });
  ...
  describe('findMovieById', () => {
    ...
    it('deve lançar uma exeção', async () => {
      ...
      await expect(moviesController.findMovieById(id)).rejects.toThrowError(
        '!ERRO!',
      );
    });
  });
  ...
  describe('createMovie', () => {
    ...
    it('deve lançar uma exeção', async () => {
      ...
      await expect(moviesController.createMovie(body)).rejects.toThrowError(
        '!ERRO!',
      );
    });
  });
  ...
  describe('updateMovie', () => {
    ...
    it('deve lançar uma exeção', async () => {
      ...
      await expect(moviesController.updateMovie(id, body)).rejects.toThrowError(
        '!ERRO!',
      );
    });
  });
  ...
  describe('remove', () => {
    ...
    it('deve lançar uma exeção', async () => {
      ...
      await expect(moviesController.deleteMovie(id)).rejects.toThrowError(
        '!ERRO!',
      );
    });
  });
